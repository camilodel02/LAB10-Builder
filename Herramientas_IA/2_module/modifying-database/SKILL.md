...
4. **(Opcional) Recuperaci+on por migraciones corruptas
...
Copia bajo `Herramientas_IA/2_module/`. Cursor puede cargar el skill desde `.cursor/skills/modifying-database/SKILL.md`; al editar, mantén ambas copias sincronizadas.
