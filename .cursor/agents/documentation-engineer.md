...
- Copia equivalente en el repo: `Herramientas_IA/2_module/agents/documentation-engineer.md`.
...
- **Consistencia:** mismo tono y idioma que el README existente (español en LAB10 si ya está así).
