...
Copia bajo documentación del módulo. Cursor descubre el skill desde `.cursor/skills/defining-tdd/SKILL.md`; al editar el contenido, mantén ambas copias sincronizadas.
