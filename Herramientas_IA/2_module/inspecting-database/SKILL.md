...
Copia bajo `Herramientas_IA/2_module/`. Cursor puede cargar el skill desde `.cursor/skills/inspecting-database/SKILL.md`; al editar, mantén ambas copias sincronizadas.
