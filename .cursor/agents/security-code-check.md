...
- **Copia en repo:** [Herramientas_IA/2_module/agents/security-code-check.md](Herramientas_IA/2_module/agents/security-code-check.md) es equivalente para referencia o si sincronizas `.cursor` desde el repo.
